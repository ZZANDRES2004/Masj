<%-- 
    Document   : admin
    Created on : 5/07/2025, 10:53:42 p. m.
    Author     : User
--%>
...
<body>
    ...
    <section class="izquierda">
        ...
        <ul class="nave" style="list-style: none;">
            ...
            <li class="users" data-target="usuarios-content"><span class="icono"><svg
                        xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#1f1f1f">
                        <path
        ...
        <div class="dashboard">
            ...
            <div class="cards">
                ...
                <button class="revisar">
                    <img class="ir" src="svg/angulo-pequeno-derecho.png" alt="ir" width="16px">
                    <span class="direccion">
                        <a href="#"> Ir</a> </span>
                </button>
            </div>
    ...
    <main id="alertas-content" class="contenido2 content-section hidden">
        ...
        <div  class="dashboard">
            ...
            <ul style="list-style: none;">
                <li class="alerta1">
                    <img src="campana.png" alt="alerta">
            ...
            <button class="revisar">
                <img class="ir" src="/src/angulo-pequeno-derecho.png" alt="ir" width="16px">
                <span class="direccion">
                    <a href="#"> Ir</a> </span>
            </button>
        </div>
    ...
    <main id="reportes-content" class="contenido3 content-section hidden">
        <div class="chart-header">
            ...
            <div class="chart-controls">
                <button class="chart-btn" onclick="changeView('week')">Semana</button>
                <button class="chart-btn" onclick="changeView('month')">Mes</button>
                <button class="chart-btn" onclick="changeView('year')">Año</button>
            </div>
        </div>
    ...
    <main id="usuarios-content" class="contenido4 content-section hidden">
        ...
        <div class="dashboard">
            ...
            <ul style="list-style: none;">
                <li class="usuarios">
                    <div class="usu">
                        <img src="/src/view/usuario (1).png" alt="">
                        <div>Andres Martinez (Empleado)</div>
                    </div>
                </li>
                <hr>
                <li class="usuarios">
                    <div class="usu">
                        <img src="/src/view/usuario (1).png" alt="">
                        <div>Nicolas Andres (Empleado)</div>
                    </div>
                </li>
                <hr>
                <li class="usuarios">
                    <div class="usu">
                        <img src="/src/llave.png" alt="">
                        <div>Bruno Mars (Administrador)</div>
                    </div>
                </li>
    ...
    <main>
        <div id="planta1">
            <img class="planta1" src="/src/svg/plants/planta1.webp" width="500px" height="500px" alt="">
        </div>

        <div class="planta2">
            <img class="planta2" src="/src/svg/plants/planta2.webp" width="500px" height="500px" alt="">
        </div>

        <div class="planta3">
            <img class="planta3" src="/src/svg/plants/planta6.webp" width="500px" height="500px" alt="">
        </div>

        <div class="frutas">
            <img src="/src/svg/plants/Untitled-design.webp" width="1200px" height="700px" alt="">
        </div>

        <div class="arbol">
            <img src="/src/svg/plants/planta4.webp" width="1200px" height="700px" alt="">
        </div>
    </main>
</body>
